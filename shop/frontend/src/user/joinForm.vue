    ...
    <div class="container">
      <form @submit.prevent="joinUser" class="member-container">
        ...
        <div class="user-info">
          ...
          <div class="form-group">
            <input type="text" id="user_name" v-model="userInfo.user_name" placeholder="이름" class="form-control" />
          </div>
          ...
          <div class="form-group">
            <input type="text" id="user_detail_addr" v-model="userInfo.user_detail_addr" placeholder="상세주소" class="form-control" />
          </div>
