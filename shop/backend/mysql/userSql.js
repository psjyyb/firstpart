module .exports =	{
  ...
  userLogin : `SELECT * FROM user WHERE user_id = ? AND user_pw = ?`,
...
WHERE user_id = ?`,
  ...
  userFindPw : `SELECT * FROM user WHERE user_name = ? AND user_phone =? AND user_id = ?`,
  changePw : 'UPDATE user SET user_pw = ? WHERE user_id = ?'
};
